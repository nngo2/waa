...
insert into product(description, price, product_name, product_type, product_image) values('Vietnames Back Peppeh FisSpecial', 7.5, 'Menu 7', 'DINNER', '/resources/images/fish.jpg');